...
namespace CW.Common
{
    ...
    public class CwDemoButton : MonoBehaviour, IPointerDownHandler
    {
        ...
        public ToggleType IsolateToggle { set { isolateToggle = value; } get { return isolateToggle; } }
